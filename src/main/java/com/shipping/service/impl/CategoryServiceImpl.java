...
public class CategoryServiceImpl implements ICategoryService {
    ...
    public ServerResponse addCategory(String categoryName, Integer parentId) {
        ...
        int rowCount = categoryManager.insert(category);
        if (rowCount>0) {
    ...
    public ServerResponse updateCategoryName(Integer categoryId, String categoryName) {
        ...
        category.setName(categoryName);
        int rowCount = categoryManager.updateByPrimaryKeySelective(category);
        if (rowCount>0) {
    ...
    public ServerResponse<List<Category>> getChildrenParallelCategory(Integer categoryId) {
        List<Category> categoryList = categoryManager.selectCategoryChildrenByParentId(categoryId);
    ...
    private Set<Category> findChildCategory(Set<Category> categories, Integer categoryId) {
        Category category = categoryManager.selectByPrimaryKey(categoryId);
        if (category != null) {
